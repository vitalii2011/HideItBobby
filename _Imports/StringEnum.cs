//SOURCE: https://github.com/gerardog/StringEnum/blob/master/StringEnum/StringEnum.cs
...
namespace StringEnum
{
    ...
    internal abstract class StringEnum<T> : IEquatable<T> where T : StringEnum<T>, new()
    {
